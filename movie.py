"""
This is the movies module and supports all the REST actions for the movies data
"""
...
def read_all():
    ...
    movie = Movie.query.order_by(Movie.title).limit(25)
...
def create(director_id, movie):
    ...
    # Was a person found?
    if director is None:
        abort(404, f"Director not found for Director Id: {director_id}")
